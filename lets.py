...
def make_app():
	return tornado.web.Application([
		...
		(r"/p/verify", redirectHandler.handler, dict(destination="https://relax.akatsuki.pw/index.php?p=2")),
		(r"/u/(.*)", redirectHandler.handler, dict(destination="https://relax.akatsuki.pw/index.php?u={}")),
